 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Feminine_Style_Feature' ) ) {

	class Feminine_Style_Feature extends WP_Widget {
		...
		private function defaults(){
			...
			$defaults = array(
				...
				'sub_title'         => '',
				'bg_image'          => '',
				'button_one_text'   => esc_html__( 'Download Resume', 'feminine-style' ),
				'button_one_url'    => '',
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__('AT Feature Section', 'feminine-style'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Parallax Section.', 'feminine-style' )
                    )
			);
		}
	...
	} // Class Feminine_Style_Feature ends here
}