 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Feminine_Style_Contact' ) ) {

    class Feminine_Style_Contact extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                    ...
                    esc_html__('AT Contact Section', 'feminine-style'),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show Contact Section.', 'feminine-style' )
                    )
            );
        }
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'shortcode' ) ); ?>"><?php esc_html_e( 'Enter Shortcode', 'feminine-style' ); ?>:</label>
                ...
                <small>
                    <?php
                    printf( esc_html__( 'Download contact form 7 from %1$shere%2$s', 'feminine-style' ), "<a target='_blank' href='".esc_url( 'https://wordpress.org/plugins/contact-form-7/' )."''>","</a>" );
                    ?>
                </small>
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php esc_html_e( 'Select Page For Contact', 'feminine-style' ); ?>:</label>
                <br />
                <small><?php esc_html_e( 'Select page and its title and excerpt will display in the frontend. No need of subpages.', 'feminine-style' ); ?></small>
                <?php
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'single_page_content_from' ) ); ?>"><?php _e( 'Page Content From', 'feminine-style' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'single_page_content_number' ) ); ?>"><?php _e( 'Number of page words in content', 'feminine-style' ); ?>:</label>
                <br/>
                <small>
        ...
        public function update( $new_instance, $old_instance ) {
            ...
            $instance[ 'page_id' ]              = feminine_style_sanitize_page( $new_instance[ 'page_id' ] );

            $feminine_style_about_content_from           = feminine_style_content_from();
            $instance['single_page_content_from']       = feminine_style_sanitize_choice_options( $new_instance['single_page_content_from'], $feminine_style_about_content_from, 'content' );
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            if( !empty ( $page_id ) ) :
                                ...
                                $contact_page_query = new WP_Query( $feminine_style_post_in_page_args );
                                /*The Loop*/
                                        ...
                                        <div class="col-md-4  <?php echo esc_attr( $animation ); ?>">
                                            <div class="contact-page-content">
                                                ...
                                                if( 0 != $single_page_content_number ){
                                                    feminine_style_advanced_content( $single_page_content_number, $single_page_content_from );
                                                }
                                                ?>
                                            </div>
                                        </div>
    ...
    } // Class Feminine_Style_Contact ends here
}