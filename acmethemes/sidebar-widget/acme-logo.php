 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Feminine_Style_Advanced_Image_Logo' ) ) {

	class Feminine_Style_Advanced_Image_Logo extends WP_Widget {
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__( 'AT Advanced Image/Logo', 'feminine-style' ),
                    /*Widget description*/
                    array( 'description' => esc_html__( 'Show Image/Logo with advanced options', 'feminine-style' ), )
			);
		}
		...
		public function form( $instance ) {
            ...
            <!--updated code-->
            <label><?php esc_html_e( 'Add Image and Link', 'feminine-style' ); ?></label>
            <br/>
            <small><?php esc_html_e( 'Add Logo, Reorder and Remove.', 'feminine-style' ); ?></small>
                        ...
                        <div class="repeater-table">
                            <div class="at-repeater-top">
                                ...
                                <div class="at-repeater-title">
                                    <h3><?php esc_html_e( 'Select Logo', 'feminine-style' )?><span class="in-at-repeater-title"></span></h3>
                                </div>
                            </div>
                            <div class='at-repeater-inside hidden'>
	                            ...
	                            ?>
                                <span class="img-preview-wrap" <?php echo esc_attr( $feminine_style_display_none ); ?>>
                                    <img class="widefat" src="<?php echo esc_url( $logo_detail['logo_img_url'] ); ?>" alt="<?php esc_attr_e( 'Image preview', 'feminine-style' ); ?>"  />
                                ...
                                <p>
                                    <label><?php esc_html_e( 'Enter Image Link', 'feminine-style' ); ?></label>
                ...
                <script type="text/html" class="at-code-for-repeater">
                    <div class="repeater-table">
                        ...
                        <div class='at-repeater-inside hidden'>
	                        ...
	                        ?>
                            <span class="img-preview-wrap" <?php echo esc_attr( $feminine_style_display_none ) ; ?>>
                                <img class="widefat" src="" alt="<?php esc_attr_e( 'Image preview', 'feminine-style' ); ?>"  />
                            </span><!-- .img-preview-wrap -->
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'column_number' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'column_number' ) ); ?>">
					<?php
					$feminine_style_logo_column_numbers = feminine_style_widget_column_number();
					foreach ( $feminine_style_logo_column_numbers as $key => $value ) {
						?>
		...
		public function widget( $args, $instance ) {
			...
			?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="at-widgets acme-advanced-image-logo <?php echo $bg_gray_class;?>">
                <div class="container">
                    <?php
                    if( ! empty( $title ) ){
	                ...
	                ?>
                    <div class="acme-advanced-image-logo-wrap">
    			                ...
    			                foreach ( $at_all_logo_items as $logo_detail ){
    				                if( isset( $logo_detail['logo_img_url'] ) && !empty( $logo_detail['logo_img_url'] ) ){
					                    ...
					                    if ( 1 == $column_number ) {
						                    ...
						                    $feminine_style_list_classes .= "col-xs-6 col-sm-6";
					                    } elseif ( 3 == $column_number ) {
						                    $feminine_style_list_classes .= "col-xs-6 col-sm-4 col-md-4";
					                    } else {
						                    $feminine_style_list_classes .= "col-xs-6 col-sm-3 col-md-3";
					                    }
    					                ?>
	...
	} // Class Feminine_Style_Advanced_Image_Logo ends here
}