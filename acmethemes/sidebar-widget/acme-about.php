 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Feminine_Style_About' ) ) {

	class Feminine_Style_About extends WP_Widget {
		...
		private function defaults(){
			...
			$defaults = array(
				...
				'featured_image'    => '',
				'design_type'                  => 'normal',
				'button_one_text'   => esc_html__( ' View More', 'feminine-style' ),
				'button_one_url'    => '',
				'button_two_text'   => esc_html__( ' View More', 'feminine-style' ),
				'button_two_url'    => ''
			);
			return $defaults;
		}
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__( 'AT About Section', 'feminine-style' ),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show About Section with image and description.', 'feminine-style' )
                    )
			);
		}
		...
		public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'sub_title' ) ); ?>"><?php _e( 'Short Description', 'feminine-style' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'some_content' ) ); ?>"><?php _e( 'Short Content', 'feminine-style' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'featured_image' ) ); ?>">
					<?php esc_html_e( 'Select Featured Image', 'feminine-style' ); ?>
                </label>
				<?php
                ...
                <span class="img-preview-wrap" <?php echo  $feminine_style_display_none ; ?>>
                    <img class="widefat" src="<?php echo esc_url( $featured_image ); ?>" alt="<?php esc_attr_e( 'Image preview', 'feminine-style' ); ?>"  />
                ...
                <input type="button" value="<?php esc_attr_e( 'Upload Image', 'feminine-style' ); ?>" class="button media-image-upload" data-title="<?php esc_attr_e( 'Select Featured Image','feminine-style'); ?>" data-button="<?php esc_attr_e( 'Select Featured Image','feminine-style'); ?>"/>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'design_type' ) ); ?>">
					<?php esc_html_e( 'Design Type', 'feminine-style' ); ?>
                </label>
                <select class="widefat at-display-select" id="<?php echo esc_attr( $this->get_field_id( 'design_type' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'design_type' ) ); ?>" >
					<?php
					$feminine_style_widget_design_types = feminine_style_widget_design_type();
					foreach ( $feminine_style_widget_design_types as $key => $value ){
						?>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_one_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'feminine-style' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_one_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'feminine-style' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_two_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'feminine-style' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_two_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'feminine-style' ); ?></label>
		...
		public function update( $new_instance, $old_instance ) {
			...
			$feminine_style_widget_design_types     = feminine_style_widget_design_type();
			$instance['design_type']               = feminine_style_sanitize_choice_options( $new_instance['design_type'], $feminine_style_widget_design_types, 'normal' );
		...
		public function widget( $args, $instance ) {
			...
			?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="at-widgets at-feature-about <?php echo esc_attr( $design_type ); ?>">
                <div class="container">
                    <div class="row">
                        <?php
                        $col = "col-sm-12";
	...
	} // Class Feminine_Style_About ends here
}