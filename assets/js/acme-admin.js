(function ( $, window, document, undefined ) {
    ...
    at_document.ready( function() {
        ...
        at_document.on('click', '.at-icons-wrapper .single-icon', function() {
            ...
            at_customize_icons.find('.icon-preview').html('<i class="' + icon_value + '"></i>');
        ...
        function at_build_hide_unnecessary_meta() {
            var page_template = $('#page_template'),
                lfeminine_style_template_builder_metabox = $('#feminine_style_template_builder_metabox'),
                feminine_style_sidebar_layout = $('#feminine_style_sidebar_layout'),
                feminine_style_meta_fields = $('#feminine_style_meta_fields'),
            ...
            if( valueSelected === 'page-templates/template-builder.php' ){
                lfeminine_style_template_builder_metabox.removeClass('hidden');
                feminine_style_sidebar_layout.addClass('hidden');
                feminine_style_meta_fields.addClass('hidden');
                postimagediv.addClass('hidden');
            }
            else{
                lfeminine_style_template_builder_metabox.addClass('hidden');
                feminine_style_sidebar_layout.removeClass('hidden');
                feminine_style_meta_fields.removeClass('hidden');
