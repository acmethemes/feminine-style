 ...
 */
function feminine_style_get_header_normal_image() {
	...
	if ( 'normal-image' == $feminine_style_header_image_display && get_header_image() ) {
 ...
 * @return void
 */
if ( ! function_exists( 'feminine_style_commment_list' ) ) :

	function feminine_style_commment_list( $comment, $args, $depth ) {
		if ( 'div' == $args['style'] ) {
			$tag       = 'div';
			$add_below = 'comment';
		} else {
		...
		<div class="comment-author vcard">
			...
			printf( __( '<cite class="fn">%s</cite>', 'feminine-style' ), get_comment_author_link() );
			?>
		</div>
		<?php if ( $comment->comment_approved == '0' ) : ?>
			<em class="comment-awaiting-moderation"><?php _e( 'Your comment is awaiting moderation.', 'feminine-style' ); ?></em>
			<br/>
		<?php endif; ?>
		<div class="comment-meta commentmetadata">
			<a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
				...
				printf( __( '%1$s at %2$s', 'feminine-style' ), get_comment_date(), get_comment_time() );
				?>
			</a>
			<?php edit_comment_link( __( '(Edit)', 'feminine-style' ), '', '' ); ?>
		</div>
		<?php comment_text(); ?>
		<div class="reply">
			<?php
 ...
 * BreadCrumb Settings
 */
if ( ! function_exists( 'feminine_style_breadcrumbs' ) ) :
	function feminine_style_breadcrumbs() {
		$feminine_style_customizer_all_values = feminine_style_get_theme_options();
		if ( 'hide' != $feminine_style_customizer_all_values['feminine-style-breadcrumb-options'] ) {
			$breadcrumb = $feminine_style_customizer_all_values['feminine-style-breadcrumb-options'];
			if ( ! is_front_page() ) {
				if ( function_exists( 'yoast_breadcrumb' ) && 'yoast' == $breadcrumb ) {
					echo "<div class='breadcrumbs init-animate'><div id='feminine-style-breadcrumbs'>";
					yoast_breadcrumb();
					echo '</div></div>';
 ...
 * @since Feminine Style 1.0.0
 *
 * @param string $feminine_style_content
 * @param int $length
 * @return string
 */
if ( ! function_exists( 'feminine_style_words_count' ) ) :
	function feminine_style_words_count( $feminine_style_content = null, $length = 16 ) {
		$length          = absint( $length );
		$source_content  = preg_replace( '`\[[^\]]*\]`', '', $feminine_style_content );
 ...
 * @return string
 */
if ( ! function_exists( 'feminine_style_blog_archive_more_text' ) ) :
	function feminine_style_blog_archive_more_text() {
		$feminine_style_customizer_all_values  = feminine_style_get_theme_options();
		$feminine_style_blog_archive_read_more = $feminine_style_customizer_all_values['feminine-style-blog-archive-more-text'];
		$feminine_style_blog_archive_read_more = esc_html( $feminine_style_blog_archive_read_more );
		return $feminine_style_blog_archive_read_more;
	}
endif;
 ...
 */
if ( ! function_exists( 'feminine_style_icons_array' ) ) {
	function feminine_style_icons_array() {
 ...
 *
 * @param null
 * @return array $feminine_style_widget_display_type
 */
if ( ! function_exists( 'feminine_style_widget_display_type' ) ) :
	function feminine_style_widget_display_type() {
		$feminine_style_widget_display_type = array(
			'column'   => esc_html__( 'Normal Column', 'feminine-style' ),
			'carousel' => esc_html__( 'Carousel Column', 'feminine-style' ),
		);
		return apply_filters( 'feminine_style_widget_display_type', $feminine_style_widget_display_type );
	}
endif;
 ...
 *
 * @param null
 * @return array $feminine_style_widget_design_type
 */
if ( ! function_exists( 'feminine_style_widget_design_type' ) ) :
	function feminine_style_widget_design_type() {
		$feminine_style_widget_design_type = array(
			'normal'  => esc_html__( 'Normal', 'feminine-style' ),
			'feature' => esc_html__( 'Feature', 'feminine-style' ),
		);
		return apply_filters( 'feminine_style_widget_design_type', $feminine_style_widget_design_type );
	}
endif;
 ...
 *
 * @param null
 * @return array $feminine_style_post_advanced_options
 */
if ( ! function_exists( 'feminine_style_post_advanced_options' ) ) :
	function feminine_style_post_advanced_options() {
		$feminine_style_post_advanced_options = array(
			'recent' => esc_html__( 'All posts', 'feminine-style' ),
			'cat'    => esc_html__( 'Categories', 'feminine-style' ),
			'tag'    => esc_html__( 'Tags', 'feminine-style' ),
		);
		return apply_filters( 'feminine_style_post_advanced_options', $feminine_style_post_advanced_options );
	}
endif;
 ...
 *
 * @param null
 * @return array $feminine_style_post_orderby
 */
if ( ! function_exists( 'feminine_style_post_orderby' ) ) :
	function feminine_style_post_orderby() {
		$feminine_style_post_orderby = array(
			'none'          => esc_html__( 'None', 'feminine-style' ),
			'ID'            => esc_html__( 'ID', 'feminine-style' ),
			'author'        => esc_html__( 'Author', 'feminine-style' ),
			'title'         => esc_html__( 'Title', 'feminine-style' ),
			'date'          => esc_html__( 'Date', 'feminine-style' ),
			'modified'      => esc_html__( 'Modified Date', 'feminine-style' ),
			'rand'          => esc_html__( 'Random', 'feminine-style' ),
			'comment_count' => esc_html__( 'Comment Count', 'feminine-style' ),
			'menu_order'    => esc_html__( 'Menu Order', 'feminine-style' ),
		);
		return apply_filters( 'feminine_style_post_orderby', $feminine_style_post_orderby );
	}
endif;
 ...
 *
 * @param null
 * @return array $feminine_style_post_order
 */
if ( ! function_exists( 'feminine_style_post_order' ) ) :
	function feminine_style_post_order() {
		$feminine_style_post_order = array(
			'ASC'  => esc_html__( 'ASC', 'feminine-style' ),
			'DESC' => esc_html__( 'DESC', 'feminine-style' ),
		);
		return apply_filters( 'feminine_style_post_order', $feminine_style_post_order );
	}
endif;
 ...
 */
if ( ! function_exists( 'feminine_style_excerpt_words_count' ) ) :

	function feminine_style_excerpt_words_count( $length = 40, $content_from = 'excerpt', $post_obj = null ) {
 ...
 * @return void
 */
if ( ! function_exists( 'feminine_style_advanced_content' ) ) :

	function feminine_style_advanced_content( $content_length = 40, $content_from = 'excerpt' ) {
		...
		if ( $content_length < 0 ) {
			...
			$content = feminine_style_excerpt_words_count( $content_length, $content_from );
